...
function createNewQuestionCours(data)
{
	...
	content_header.appendChild(document.createTextNode("Question "+nbrQuestion));
	...
	createSaveFormCours(data,nbrQuestion);
}

function createSaveFormCours(data,nbrQuestion)
{
	var mainForm = document.getElementById("saveFormQCours");
