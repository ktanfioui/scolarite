    ...
    <script type="text/javascript" src="../../public/js/form-components.js"></script>
    <script src="../../public/plugins/checkbox/zepto.js"></script>
    <script src="../../public/plugins/checkbox/icheck.js"></script>
    <script src="../../public/js/icheck-init.js"></script>
    <script src="../../public/js/jquery.slimscroll.min.js"></script>
    <script src="../../public/js/icheck.js"></script>

    <script src="../../public/outils/examen/qcm.js"></script>
    <script src="../../public/outils/examen/qcours.js"></script>
    <script src="../../public/outils/examen/exercice.js"></script>
