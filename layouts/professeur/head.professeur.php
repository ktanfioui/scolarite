...
<head>
  ...
  <link href="../../public/plugins/checkbox/icheck.css" rel="stylesheet" type="text/css" />
  <link href="../../public/plugins/checkbox/minimal/blue.css" rel="stylesheet" type="text/css" />
</head>
	      ...
	      <div class="top_right_bar">
	        ...
	        <div class="user_admin dropdown"> 
	          <a href="javascript:void(0);" data-toggle="dropdown"><img src="../../public/images/user.jpg" />
	          	<span class="user_adminname"><?php echo $_SESSION['professeur']["nom"]." ".$_SESSION['professeur']["prenom"]; ?></span> <b class="caret"></b> </a>
