    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          ...
          <h2 class="">Création d'un nouveau Module</h2>
        </div>
      </div>
      <!-- Page Content -->
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="block-web">
              <div class="header">
                <h3 class="content-header">Nouveau Module</h3>
              </div>
              <div class="porlets-content">
                <form action="creationModule.controller.php" class="form-horizontal row-border" method="POST">
